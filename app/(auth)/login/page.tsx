    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <span className="text-2xl font-bold text-primary">BroCook</span>
        </div>

        <Card className="shadow-lg">
          <CardHeader className="text-center pb-2">
            <CardTitle>Welcome back!</CardTitle>
            <CardDescription>Sign in to continue with your Bro companion.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 pt-4">
            ...
            >
              ...
              />
              <Button type="submit" variant="secondary" className="w-full gap-2 h-11">
        ...
        <p className="mt-4 text-center text-xs text-muted-foreground">
          New users get a <strong className="text-foreground">14-day free trial</strong> — no credit card required.
        </p>
      </div>
    </div>
  )
